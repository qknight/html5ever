...
in
  pkgs.stdenv.mkDerivation rec {
    name = "serde-1_0_218-script_build-6e5c408cc517c124";
    buildInputs = [];
    ...
    buildPhase = ''
      ...
      echo -e "\e[92mCompiling\e[0m serde-1_0_218-script_build-6e5c408cc517c124"
      ...
      ${rustc}/bin/rustc \
        ...
        -C metadata=c87dbb19171fd2ab \
        -C extra-filename=-6e5c408cc517c124 \
        --out-dir $OUT_DIR \
        ${fn.rustc_linker_arguments passthru.rust_crate_libraries} \
        ${fn.rustc_propagated_arguments passthru.rust_script_build_run} \
        --cap-lints allow
      ln -s $OUT_DIR/"$CARGO_CRATE_NAME"-6e5c408cc517c124 $OUT_DIR/build_script_build
      )
    '';
}
